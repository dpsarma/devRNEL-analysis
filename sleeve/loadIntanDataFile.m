function y = loadIntanDataFile(pathDataFolder, fnameIntan)
...
if nargin < 2,
    [fnameIntan, pathDataFolder, filterindex] = ...
...
dFile = fullfile(pathDataFolder, fnameIntan);
...
y.filename = fnameIntan;
y.path = pathDataFolder;
y.notes = notes;
y.amplifier_channels = amplifier_channels;
y.amplifier_data = amplifier_data;
y.aux_input_channels = aux_input_channels;
y.aux_input_data = aux_input_data;
y.board_dig_in_channels = board_dig_in_channels;
y.board_dig_in_data = board_dig_in_data;
% y.reference_channel = reference_channel;
y.frequency_parameters = frequency_parameters;
% y.reference_channel = reference_channel;
% y.spike_trigger_struct = spike_trigger_struct;
y.spike_triggers = spike_triggers;
y.supply_voltage_channels = supply_voltage_channels;
y.supply_voltage_data = supply_voltage_data;
y.t_amplifier = t_amplifier;
y.t_aux_input = t_aux_input;
y.t_dig = t_dig;
y.t_supply_voltage = t_supply_voltage;

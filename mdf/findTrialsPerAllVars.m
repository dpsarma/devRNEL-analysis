function [allUUID] = findTrialsPerAllVars(dateString, elecString, freqString, pulseString)

%     dateString = '2018-10-05';
%     elecString = 'Unipolar: 01';
    ...
    match4 = BasicDBObject('mdf_metadata.electrodeLabel', BasicDBObject('$eq', elecString));
    match5 = BasicDBObject('mdf_metadata.stimParams.freq', BasicDBObject('$eq', freqString));
    match6 = BasicDBObject('mdf_metadata.stimParams.width', BasicDBObject('$eq', pulseString));
